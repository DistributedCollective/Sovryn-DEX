...
describe('Pool Governance', () => {
    ...
    beforeEach("deploy",  async () => {
      ...
      let factory = await ethers.getContractFactory("SdexPolicy");
      policy = (await factory.deploy((await test.dex).address)) as SdexPolicy;
      policy2 = (await factory.deploy((await test.dex).address)) as SdexPolicy;
      pool = await test.dex
