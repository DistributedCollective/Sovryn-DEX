...
import { SdexPoolParams } from "../constants/poolParams";
import { SdexProtocolCmd } from "./governance";

export function initLiqCmd (params: SdexPoolParams): SdexProtocolCmd {
...
export function poolStdTemplCmd (params: SdexPoolParams): SdexProtocolCmd {
    const abi = new AbiCoder()
