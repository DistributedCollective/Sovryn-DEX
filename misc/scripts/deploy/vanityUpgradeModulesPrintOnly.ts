...
async function install() {
    ...
    console.log("Install warm path:", cmd)
    // await traceContractTx(policy.treasuryResolution(
    ...
    console.log("Install hot proxy path:", cmd)
    // await traceContractTx(policy.treasuryResolution(
    ...
    console.log("Install micro paths:", cmd)
    // await traceContractTx(policy.treasuryResolution(
    ...
    console.log("Install knockout liquidity proxy path:", cmd)
    // await traceContractTx(policy.treasuryResolution(
    ...
    console.log("Install knockout cross proxy path:", cmd)
    // await traceContractTx(policy.treasuryResolution(
    ...
    for(const lpTokenConfig of lpTokenConfigs) {
        ...
        console.log(`Register pool lp token for base ${lpTokenConfig.baseToken.tokenSymbol} - quote ${lpTokenConfig.quoteToken.tokenSymbol}`, cmd)
    ...
    cmd = abi.encode(["uint8", "address"],
        ...
        console.log("Register pool lp token deployer address", cmd)
    // await traceContractTx(policy.opsResolution(addrs.dex, COLD_PROXY_IDX, 
