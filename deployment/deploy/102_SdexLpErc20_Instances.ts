...
const func: DeployFunction = async ({
  ...
  let sdexLpErc20PairsData = [
    ...
    { base: tBTC, quote: SOV, poolIdx: poolIdx },
    { base: rETH, quote: SOV, poolIdx: poolIdx },
    { base: wstETH, quote: SOV, poolIdx: poolIdx },
    { base: USDT, quote: SOV, poolIdx: poolIdx },
    { base: USDC, quote: SOV, poolIdx: poolIdx },
    { base: DAI, quote: SOV, poolIdx: poolIdx },
